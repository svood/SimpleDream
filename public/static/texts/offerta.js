const ua = () => (
    <div>
        ...
        <div class="article-text __fullWidth text">
            ...
            <p><b>відповідальна особа</b>&nbsp;— визначена особа ФОП "Возный Богдан Миколайович", яка організовує роботу, пов’язану із&nbsp;захистом персональних даних при їх&nbsp;обробці, відповідно до&nbsp;закону;</p>
...
const ru = () => (
    <div>
        ...
        <p>
            1.1. Настоящая оферта, является официальным предложением Simple Dreams в лице ФЛП "Возный Богдан Николаевич", далее по тексту — «Продавец», заключить Договор купли-продажи товаров дистанционным способом, то есть через Интернет-магазин, далее по тексту — «Договор», и размещает Публичную оферту (предложение) на официальном интернет-сайте Продавца «https://simple-dreams.com.ua (далее - «Интернет-сайт»).
                    </p>
        <p>
