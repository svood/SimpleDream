    ...
    <div>
        ...
        <div class="article-text __fullWidth text">
            ...
            <ol>
                ...
                <li>Захист персональних даних: способи захисту, відповідальна особа в, працівники, які безпосередньо здійснюють обробку та/або мають доступ до&nbsp;персональних даних у&nbsp;зв’язку з&nbsp;виконанням своїх службових обов’язків, строк зберігання персональних даних</li>
            ...
            <p><b>відповідальна особа</b>&nbsp;— визначена особа в лиці директора Шах Богдана Вікторовича, яка організовує роботу, пов’язану із&nbsp;захистом персональних даних при їх&nbsp;обробці, відповідно до&nbsp;закону;</p>
...
const ru = () => (
    <div>
        ...
        <p>
            1.1. Настоящая оферта, является официальным предложением Simple Dreams в лице директора Шах Богдана Викторовича, далее по тексту — «Продавец», заключить Договор купли-продажи товаров дистанционным способом, то есть через Интернет-магазин, далее по тексту — «Договор», и размещает Публичную оферту (предложение) на официальном интернет-сайте Продавца «https://simple-dreams.com.ua (далее - «Интернет-сайт»).
                    </p>
        <p>
